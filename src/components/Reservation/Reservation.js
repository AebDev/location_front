...
function Reservation(props) {
    ...
    useEffect(() => {
        ...
        async function fetchData() {
            const result = await axios.get(`http://127.0.0.1:8000/api/vehicule/${props.match.params.id}`);
    ...
    function dateDiff(date1, date2) {
        ...
        let dt1 = date1.split("-");
        let dt2 = date2.split("-");
        const dif = Math.floor((Date.UTC(dt2[2], dt2[1], dt2[0]) - Date.UTC(dt1[2], dt1[1], dt1[0])) / (1000 * 60 * 60 * 24));
    ...
    const totalCalc = () =>{
        const calc = (car.cout_par_jour*diff)+parseFloat(car.franchise) + totalAssurance + totalOption;
        return calc;
    };
            ...
            <Form size="large" >
                ...
                <Grid style={{ height: "100vh" }} doubling stackable >
                    ...
                    <Grid.Column width={12}>
                        ...
                        <Segment stacked >
                            <Grid columns={4}>
                                <Grid.Column><Icon size='large' name='wifi' /></Grid.Column>
                                <Grid.Column><Header>Wi-Fi</Header></Grid.Column>
                                <Grid.Column>
                                    <Form.Checkbox 
                                        name='wifi' 
                                        value={wifi} 
                                ...
                                <Grid.Column><Header>100 DH</Header>par jour</Grid.Column>
                            </Grid>
                            <Grid columns={4}>
                                <Grid.Column><Icon size='large' name='location arrow' /></Grid.Column>
                                <Grid.Column><Header>GPS</Header></Grid.Column>
                                <Grid.Column>
                                    <Form.Checkbox 
                                        name='gps' 
                                        value={gps} 
                            ...
                            <Grid columns={4}>
                                <Grid.Column><FontAwesomeIcon icon={faBaby} size="lg" /></Grid.Column>
                                <Grid.Column><Header>Siège bébé 0 à 3 ans</Header></Grid.Column>
                                <Grid.Column>
                                    <Form.Checkbox 
                                        name='baby' 
                                        value={bebe} 
                                ...
                                <Grid.Column><Header>70 DH</Header>par jour</Grid.Column>
                            </Grid>
                            <Grid columns={4}>
                                <Grid.Column><Icon size='large' name='child' /></Grid.Column>
                                <Grid.Column><Header>Rehausseur enfant</Header></Grid.Column>
                                <Grid.Column>
                                    <Form.Checkbox 
                                        name='child' 
                                        value={enfant} 
                                ...
                                <Grid.Column><Header>40 DH</Header>par jour</Grid.Column>
                            </Grid>
                        ...
                        <Segment stacked >
                            <Grid>
                                <Grid.Column width={8} textAlign="left">
                                    <Header style={{ marginBottom: '0' }}>Protection de Base</Header>
                                ...
                                <Grid.Column width={4}>
                                    <Form.Radio name='assurance'
                                        checked={assurance === '1'}
                                        onChange={assuranceHandleChange}
                                        type='radio' value='1' />
                                </Grid.Column>
                                <Grid.Column width={4}><Header>0 DH</Header>
                                </Grid.Column>
                            </Grid>
                            <Grid>
                                <Grid.Column width={8} textAlign="left">
                                    <Header style={{ marginBottom: '0' }}>Protection Standard</Header>
                                ...
                                <Grid.Column width={4}><Header>60 DH</Header>par jour</Grid.Column>
                            </Grid>
                            <Grid>
                                <Grid.Column width={8} textAlign="left">
                                    <Header style={{ marginBottom: '0' }}>Protection Premium</Header>
                                    <p>remboursement de la franchise 100% <Label color='teal'> <Icon name='star' />Recommandée</Label></p>
                                </Grid.Column>
                                <Grid.Column width={4}>
                                    <Form.Radio name='assurance'
                                        checked={assurance === '3'}
                                ...
                                <Grid.Column width={4}><Header>80 DH</Header>par jour</Grid.Column>
                            </Grid>
                        ...
                        <Segment stacked >
                            <Header as='h4' textAlign='left'><Icon color='teal' name='question circle outline' />Ces informations sont importantes. En effet, si votre vol a du retard, l’agence de location sera informée.</Header>
                            <Grid columns={3}>
                                ...
                                <Grid.Column><Form.Checkbox label=' Je n’ai pas de numéro de vol' name='baby' value='true' /></Grid.Column>
                    ...
                    <Grid.Column width={4}>
                        ...
                        <Segment stacked textAlign='left'>
                            ...
                            <Label style={{ marginBottom: '1rem' }} color="teal" >Depart</Label>
                            <p>{reserv.resInfo.start}</p>

                            <Label style={{ marginBottom: '1rem' }} color="teal" >Retour</Label>
                        ...
                        <Segment stacked textAlign='left' >
                            ...
                            <Header as="h4" textAlign='center' color="grey">{car.cout_par_jour} DH x {diff} jours</Header>
                            <Header as="h4"  color="grey">+ Franchise : {car.franchise} DH</Header>
                            <Header as="h4" color="grey">+ assurance : {totalAssurance} DH</Header>
                            <Header as="h4" color="grey">+ Option : {totalOption} DH</Header>
                            <Header as="h3" textAlign='center' >{totalCalc()} DH TTC</Header>
                        ...
                        <Segment stacked >
                            ...
                            <Label style={{ marginBottom: '1rem' }} color="teal" >Category</Label>
